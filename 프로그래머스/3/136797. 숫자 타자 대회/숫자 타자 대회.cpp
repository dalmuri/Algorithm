...
int solution(string numbers) {
    ...
    vector<vector<vector<int>>> weights(numbers.size() + 1, vector<vector<int>>(10, vector<int>(10, INT_MAX))); // weights[i+1][l][r] = numbers[i]까지 누른 후 왼손과 오른손이 각각 l, r 위에 있을 때의 가중치 합
    weights[0][4][6] = 0;
